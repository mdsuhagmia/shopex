...
const BanSlick1 = () => {
  ...
  return (
    <div className='bg-gray-50 shadow sandisk'>
      {cateShow.map((item) => (
        <div className='grid grid-cols-2 gap-x-4 py-12'>
          <div>
            ...
            <Link className='text-md font-semibold font-lat text-[#fff] ml-30 mt-4 bg-gray-950 px-8 py-2 rounded-[5px] inline-block hover:bg-gray-600'>
              Shop Now
            </Link>
          </div>
          <div className='px-22'>
